...
function ContactPageForm({ pageCopy }: { pageCopy: PageCopy }) {
  ...
  return (
    <main className="pt-16">
        <PageHero
          kicker={str(pageCopy, "kicker", "Get in Touch")}
          title={str(pageCopy, "title", "Contact Us")}
          description={str(
            pageCopy,
            "description",
...
export function ContactPageClient({ pageCopy }: { pageCopy: PageCopy }) {
  return (
    <Suspense fallback={null}>
      <ContactPageForm pageCopy={pageCopy} />
    </Suspense>
  )
}
